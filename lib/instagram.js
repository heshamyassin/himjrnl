/*1680455472,,JIT Construction: v1007229429,en_GB*/
...
try {
            ...
            with(this) {
                ...
                __d("polarisOnDOMReady", ["ExecutionEnvironment", "PolarisEventListener"], (function(a, b, c, d, e, f, g) {
                    ...
                    if (c("ExecutionEnvironment").canUseDOM) {
                        ...
                        d || (h = [], c("PolarisEventListener").add(document, "DOMContentLoaded", a), c("PolarisEventListener").add(window, "load", a))
                    }
                    g["default"] = b
                }), 98);
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "embed.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1007229429","namespace":"FB","message":"' + e.message + '"}}');
