Function && Function.prototype && Function.prototype.bind && (/(MSIE ([6789]|10|11))|Trident/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || function(t) {
    ...
    t.exports = function(t, e, n) {
        ...
        return t.id && (o.id = t.id, delete t.id), o.allowtransparency = "true", o.scrolling = "auto", o.setAttribute("frameBorder", 0), o.setAttribute("allowTransparency", !0), i.forIn(t, function(t, e) {
            o.setAttribute(t, e)
    ...
    t.exports = a.couple(n(58), function(t) {
        t.overrideProperty("id", {
            ...
            return o.read(function() {
                ...
                "visible" == t.sandboxEl.style.visibility ? t._width = '100%' : (e = h(t.sandboxEl.parentElement).width, t._width = '100%'), t._height = n.height
            })
    ...
    var r = n(113),
        ...
        _ = "open",
        E = "SandboxRoot",
        x = ".SandboxRoot { display: none; max-height: 100%; }";
    t.exports = c.couple(n(58), function(t) {
        t.defineStatic("isSupported", function() {
            ...
            return a.read(function() {
                ...
                "visible" == t.sandboxEl.style.visibility ? t._width = '100%' : (e = l(t.sandboxEl.parentElement).width, t._width = '100%'), t._height = n.height
            })
        }), t.define("_didResize", function() {
            var t = this,
                e = this._resizeHandlers.slice(0);
    ...
    (n = function(t, e) {
        function r(t, e) {
            ...
            t.resizeSensor.style.cssText = n, t.resizeSensor.innerHTML = '<div class="resize-sensor-expand" style="' + n + '"><div style="' + r + '"></div></div><div class="resize-sensor-shrink" style="' + n + '"><div style="' + r + ' width: 100%; height: 100%"></div></div>', t.appendChild(t.resizeSensor), {
                fixed: 1,
                absolute: 1
            }[function(t, e) {
