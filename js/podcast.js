...
const togglePlay = () => {
    ...
    if (isPlaying) {
        playButtonIcon.src = '../../../resources/pics/pause.svg';
    } else {
        playButtonIcon.src = '../../../resources/pics/play.svg';
    }
};
...
const toggleMute = () => {
    ...
    if (isMuted) {
        volumeIcon.src = '../../../resources/pics/mute.svg';
        volumeSlider.disabled = true;
    } else {
        volumeSlider.disabled = false;
        volumeIcon.src = '../../../resources/pics/volume.svg';
    }
};
